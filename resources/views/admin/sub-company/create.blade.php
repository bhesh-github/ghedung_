            ...
            <div class="container-fluid">
                <div class="col-md-12 text-right">
                    <p><a 
                        ...
                        >Sub Companies</a> / Add</p>
                </div>
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title float-left">Add Sub Company</h3>
                        <a
                         href="{{ route('sub-company.index') }}" 
                    ...
                    <!-- form start -->
                    <form 
                    action="{{ route('sub-company.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="file-ip-1" accept="image/*"
                                            ...
                                            onchange="showPreview1(event);" name="company_logo" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" name="introduction" value="" placeholder="" required>{{ old('introduction') }}</textarea>
                                        @error('introduction')
                                            <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
