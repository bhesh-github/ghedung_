                ...
                @if (!$slider)
                    <div class="col-md-12 text-right">
                        <p><a 
                            {{-- href="{{ route('home') }}" --}}
                            >Home</a> / <a 
                            {{-- href="{{ route('slider.show') }}" --}}
                            >Slider</a> / Add</p>
                    </div>
                    <div class="col-md-12">
                        <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title float-left">Add Slider</h3>
                            <a 
                            href="{{ route('slider.show') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="preview mt-2">
                                            {{-- <img src="" id="file-ip-1-preview" width="200px"> --}}
                                            <img 
                                            src="{{ asset('upload/images/slider/' . $slider['image']) }}" 
