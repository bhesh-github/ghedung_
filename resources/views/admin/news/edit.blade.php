            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title float-left">Edit News</h3>
                        <a href="{{ route('news.index') }}" class="btn btn-danger float-right">Back</a>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title"
                                            value="{{ $news->title }}" placeholder="Enter Title" required>
                                        @error('title')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" name="description" value="" placeholder="Enter Description Here" required>{{ $news->description }}</textarea>
                                        @error('description')
                                            <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
