            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <p><a href="{{ route('admin.home') }}">Home</a> / Activity PDF's</p>
                    </div>
                    <!-- left column -->
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark" id="exampleModalLabel">Create Activity PDF</h5>
                            ...
                            <table id="datatable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($activity_pdf as $value)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $value->title }}</td>
                                            <td>
                                                <a href="{{ asset('upload/files/activity/'.$value->pdf_file) }}" target="__blank">{{ $value->pdf_file }}</a>
                                            </td>
                                            <td class="text-center">
                                                @if ($value->status == 'on')
                                                    <a href="{{ route('activity.status', $value->id) }}"
                                                ...
                                                <div class="modal fade" id="edit{{ $value->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('activity.update') }}"
                        ...
                        <div class="row">
                            {{$activity_pdf->links('pagination::simple-bootstrap-4')}}
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
        </section>
