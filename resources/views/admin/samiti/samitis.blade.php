            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <p><a href="{{ route('admin.home') }}">Home</a> / Samiti</p>
                    </div>
                    <!-- left column -->
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title float-left">Samiti List</h3>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark" id="exampleModalLabel">Create Samiti</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <form action="{{ route('samiti.store') }}" method="POST"
                            ...
                            <table id="datatable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($samitis as $value)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $value->title }}</td>
                                            <td >
                                                <a 
                                                href="{{ route('samiti-member-card.index',$value->slug) }}"
                                            ...
                                            <td class="text-center">
                                                @if ($value->status == 'on')
                                                    <a href="{{ route('samiti.status', $value->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="edit{{ $value->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Edit Samiti
                                                                </h5>
                                                                <button type="button" class="close" data-dismiss="modal"
                                                                    aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                            ...
                                                            <form action="{{ route('samiti.update', $value->id) }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        @enderror
                                                                        <div class="preview mt-2">
                                                                            <img src="{{ asset('upload/files/samitis/' . $value->samiti_pdf) }}"
                                                ...
                                                <form action="{{ route('samiti.delete') }}" method="post"
                                                    class="mt-1">
                                                    @csrf
