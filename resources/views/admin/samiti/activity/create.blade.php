...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Add {{$samiti->title}}  Member</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <form id="product-form" action="{{ route('samiti-member-card.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <input type="hidden"  name="samiti_slug" class="form-control" value={{$samiti->slug}}>
                                <div class="col-md-6">
