            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <p><a href="{{ route('admin.home') }}">Home</a> / Activities</p>
                    </div>
                    <!-- left column -->
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title float-left">{{$samiti->title}} Activities List</h3>
                                <a href="{{ route('samiti.index') }}"  class="btn btn-danger text-white float-right ml-2">Back</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark" id="exampleModalLabel">Create Activity</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <form action="{{ route('samiti.activity.store') }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <input type="hidden"  name="samiti_id" class="form-control" value={{$samiti->id}}>
                                ...
                                <tbody>
                                    @foreach ($activities as $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->title }}</td>
                                            <td>
                                                <a href="{{ asset('upload/files/samitis/activity/'.$value->file) }}" target="__blank">{{ $value->file }}</a>
                                            </td>
                                            <td class="text-center">
                                                @if ($value->status == 'on')
                                                    <a href="{{ route('samiti.activity.status', $value->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="edit{{ $value->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('samiti.activity.update') }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        @enderror
                                                                        <div class="preview mt-2">
                                                                            <img src="{{ asset('upload/files/samitis/activity/' . $value->file) }}"
                                                ...
                                                <form 
                                                action="{{ route('samiti.activity.delete') }}"
                                                 method="post"
                                                    class="mt-1">
                                                    @csrf
