            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <p><a href="{{ route('admin.home') }}">Home</a> / Notice</p>
                    </div>
                    <!-- left column -->
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title float-left">Notices List</h3>
                                ...
                                <tbody>
                                    @foreach ($notice as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ asset('upload/files/notice/'.$value->pdf) }}" target="__blank">{{ $value->pdf }}</a>
                                            </td>
                                            <td class="text-center">
                                                @if ($value->status == 'on')
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="edit{{ $value->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Edit Notice PDF
                                                                </h5>
                                                                <button type="button" class="close" data-dismiss="modal"
                                                                    aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                            ...
                                                            <form action="{{ route('notice.update') }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            @enderror
                                                                            <div class="preview mt-2">
                                                                                <img src="{{ asset('upload/images/notice/' . $value->image) }}"
