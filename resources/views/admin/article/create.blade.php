            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title float-left">Add Article</h3>
                        <a
                         href="{{ route('article.index') }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="article_post_date" id="article_post_date"
                                            value="{{ old('article_post_date') }}" placeholder="Enter Article Post Date" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="writer_name" id="writer_name"
                                            value="{{ old('writer_name') }}" placeholder="Enter Writer Name" required>
                                        @error('writer_name')
                                            <p style="color: red">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="writer_address" id="writer_address"
                                            value="{{ old('writer_address') }}" placeholder="Enter Writer Address" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="file-ip-1" accept="image/*"
                                            ...
                                            onchange="showPreview2(event);" name="writer_image" required>
